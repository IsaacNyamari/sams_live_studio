                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form class='w-full max-w-lg mx-auto' method='POST' action="{{ route('gallery.store') }}"
                        ...
                        <div class='flex flex-wrap -mx-3 mb-6'>
                            <div class='w-full px-3'>
                                <button
                                    class='bg-[#000080] text-white hover:bg-[#000080]/80 dark:bg-white/100 dark:text-[#000080] dark:hover:bg-gray-50 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline'
                                    type='submit'>
                                    Upload
                                </button>
                            </div>
