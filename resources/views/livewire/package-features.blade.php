   <div class="container mx-auto px-4 py-8">
       <h2 class="text-2xl font-bold mb-6 dark:text-white">Add New Package</h2>
       ...
       <form class='w-full max-w-lg mx-auto' method='POST' wire:submit.prevent="addPackage" enctype="multipart/form-data">
           @csrf
